...
enum class Option(
    ...
    FAST_CHECK("prozen-fast-checker","Ускоренная проверка публикаций",
        "Проверка публикаций будет производиться быстрее, но повышает вероятность сбоя загрузки данных.",
        false),
